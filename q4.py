...
class minimize_dfa:
    ...
    def minimize(self,states,letters,transition,start_states,final_states):
        ...
        #         continue
        #     for i2 in states:
        #         if i1 not in skip and i2 not in skip:
        #             if state_matrix[has.index(i1)][has.index(i2)]==0 and state_matrix[has.index(i2)][has.index(i1)]==0:
        #                 if i1!=i2:
        #                     if i1 not in temp_arr:
        #                         temp_arr.append(i1)
        #                     temp_arr.append(i2)
        #                     skip.append(i2)
        #                     skip.append(i1)
...
#print(nfa)
    ...
    print("Usage: python3 q4.py <inputfile> <outputfile>")